...
vim.keymap.set('n', '<leader>sa', ':%s/\\<<C-r><C-w>\\>/<C-r><C-w>/gI<Left><Left><Left>', { desc = 'Global substitute word' })

-- open Neotree filesystem. Don't need anymore, realized there was already a keymap for this.
